...
| Area | Done | Status |
|---|---|---|
| Tennis bot core | 90% | Picks, Sheets tab, Discord-only delivery (`tennis-picks`/`tennis-results`, 10 Jul 2026 — no Telegram), CLV polling, auto-results, daily picks PNG card (11 Jul 2026) all live |
